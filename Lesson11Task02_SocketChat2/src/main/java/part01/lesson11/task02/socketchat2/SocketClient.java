 ...
 * Когда пользователь отправляет unicast сообщение:
 * имя клиента - в начале сообщения,
 * после пробела идет само сообщение (без пробелов)
 */
    ...
    private void startClient() {
        try {
            ...
            try (BufferedReader reader = new BufferedReader(new InputStreamReader(socket.getInputStream()));
                ...
                logger.info("Enter STOP or you name and send message: ");
