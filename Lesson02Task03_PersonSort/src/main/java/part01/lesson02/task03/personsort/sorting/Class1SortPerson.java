...
/**
 * Класс №1 с реализацией интерфейса SortedPersons,
 * двух различных сортировок массива Person[]
 * и времени их выполнения.
 */

public class Class1SortPerson implements SortedPersons {

    /**
     * @param p - на вход подаем массив Person который требуется отсортировать и сортируем его.
     * @return long - возвращаем время работы метода сортировки в мс.
     */
